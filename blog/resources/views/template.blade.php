                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                      ...
                      <a class="nav-link" href="{{ URL('/list') }}"><i class="fas fa-align-left"></i> &nbsp; ดูรายการเอกสาร</a> 
                    </li>   <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-address-card"></i> &nbsp; จัดการเอกสาร
                      </a>
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ URL('/') }}">&nbsp;ธุรการรับ</a> 
                        <a class="dropdown-item" href="{{ URL('/') }}">&nbsp;ธุรการส่ง</a>
