...
//    echo ($get_gid);
        ...
        $url_sent_department_control_code= URL('/doneitemcontrolcode'); 
        $url_get_data=URL('/sentlist'); //รายการส่งต่อสามารถปิดเอกสารได้
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            @endif
 <form autocomplete="off" id="sent_control_code" action="{{ $url_sent_department_control_code }}" class="form-horizontal" enctype="multipart/form-data" >
...
<!--                                <span id="message_save"></span>-->
  ...
  <div class="modal fade" id="sentlistModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">เสร็จสิ้นรายการ</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="col-md-6">
    <button type="submit" class="btn btn-primary" id="btn_search">เสร็จสิ้น</button>
