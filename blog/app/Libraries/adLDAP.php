...
class adLDAP {
    ...
    * @var string
    */
  protected $_ad_account="prefix";
    /**
    * The account prefix for your domain, can be set when the class is invoked
    *
    * @var string
    */
  protected $_account_prefix="up\\";
    ...
    * @var string
    */
  protected $_account_suffix="@up.local";
    ...
    * @var string
    */
  protected $_base_dn = "DC=up,DC=local";
    ...
    * @var array
    */
  protected $_domain_controllers = array ("10.207.30.3");
  ...
  public function authenticate($username,$password,$prevent_rebind=false){
    ...
    // Bind as the user
    switch ($this->_ad_account) {
      case "prefix":
        $this->_bind = @ldap_bind($this->_conn,$this->_account_prefix.$username,$password);
        break;
      case "suffix":
  ...
  public function get_last_error() {
    ...
    /**
    * Get last error number from Active Directory
    *
    * This function gets the last message from Active Directory
    * This may indeed be a 'Success' message but if you get an unknown error
    * it might be worth calling this function to see what errors were raised
